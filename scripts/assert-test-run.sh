...
#
#   measured      1961   (1.7.6; was 1954 at 1.7.5, 1928 at 1.7.4)
#   without Kokoro  1923   (1961 - 38)
#   floor           1949   (12 under measured, 26 above the failure it must catch)
#
...
MIN_EXECUTED="${MYNAH_MIN_EXECUTED_TESTS:-1949}"
